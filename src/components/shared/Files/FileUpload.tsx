...
export const FileUpload = ({ name, onFileChange, value, file, label, getDataOcr, disabledClose = false, control }: IFileUpload) => {
            ...
            {!filePreview && (
              <div
                ...
                className={cn(
                  ...
                  !!error?.message ? 'text-red-600' : 'text-primary-600'
                )}>
                <UploadIcon error={!!error?.message} />
